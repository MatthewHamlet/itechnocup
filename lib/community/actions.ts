...
import { NOT_CONFIGURED_MESSAGE, SUPABASE_URL, isSupabaseConfigured } from "@/lib/supabase/config";
...
export async function loadProfileCard(profileId: string) {
  ...
  const myPatients: { id: string; name: string }[] = [];
