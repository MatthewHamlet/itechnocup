      ...
      <form action={action} className="flex flex-col gap-4">
        <div>
          ...
          <input
            ...
            maxLength={160}
            disabled={busy}
            placeholder="Setrika dan mesin cuci barengan bikin jeglek, gimana ya?"
        ...
        <div>
          ...
          <input
            ...
            maxLength={200}
            disabled={busy}
            placeholder="setrika, mesin cuci, jeglek"
            className={`${FIELD} mt-1.5 h-13 py-3.5`}
          />
        ...
        <div>
          ...
          {preview ? (
            <div className="relative mt-1.5 overflow-hidden rounded-2xl ring-2 ring-app-line">

              <img
                src={preview}
                alt="Pratinjau gambar"
                className="max-h-64 w-full bg-app-canvas object-contain"
              />
            ...
            <label
              htmlFor={`${uid}-image`}
              className="mt-1.5 flex h-24 w-full cursor-pointer flex-col items-center justify-center gap-1.5 rounded-2xl border-2 border-dashed border-app-line bg-white text-neutral-500 outline-none transition-colors duration-200 hover:border-farad-primary hover:bg-farad-sage/40 hover:text-farad-forest"
            >
