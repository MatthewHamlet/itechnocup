    ...
    <span className="relative inline-grid shrink-0">
      ...
      {person.verified && (
        <span
          ...
          className={`absolute -bottom-0.5 -right-0.5 grid place-items-center rounded-full bg-white text-farad-primary ring-white ${s.ring}`}
        >
...
export function SectionHead({
  ...
  return (
    <div className="mb-4 flex items-end justify-between gap-4">
      ...
      <a
        href={href}
        className="shrink-0 rounded-full px-2 py-1 text-[13px] font-semibold text-farad-primary outline-none transition-colors duration-200 hover:text-farad-forest focus-visible:ring-2 focus-visible:ring-farad-primary/40"
      >
        {linkLabel}
      </a>
    </div>
