  ...
  return (
    <li className="relative">
      <Link
        ...
        className={`group/item relative flex h-12 items-center rounded-xl px-3.5 outline-none transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-farad-primary/40 ${
          isActive
            ? "text-farad-forest"
      ...
      >
        ...
        {isActive && (
          <motion.span
            ...
            transition={pill}
            className="absolute inset-0 rounded-xl bg-white shadow-[0_1px_2px_rgba(24,32,24,0.06),0_4px_12px_-6px_rgba(24,32,24,0.18)] ring-1 ring-app-line"
          />
        )}
        ...
        {isActive && (
          <motion.span
            ...
            transition={pill}
            className="absolute -left-3.5 top-1/2 h-6 w-[3px] -translate-y-1/2 rounded-r-full bg-farad-primary"
          />
        )}
        ...
        <span className="relative z-10 grid w-7 shrink-0 place-items-center">
          ...
          {badge ? (
            <motion.span
              ...
              className="absolute -right-1 -top-1 h-2.5 w-2.5 rounded-full bg-farad-primary ring-2 ring-app-canvas"
            />
          ) : null}
        </span>
        ...
        {badge ? (
          <motion.span
            ...
            className="relative z-10 ml-auto rounded-full bg-farad-primary px-2 py-1 text-[11px] font-bold leading-none text-white"
          >
            {badge}
          </motion.span>
        ) : null}
