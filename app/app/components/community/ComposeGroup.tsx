...
const FIELD =
  "w-full rounded-2xl border-2 border-app-line bg-white px-4 text-[15px] text-neutral-900 outline-none transition-colors duration-200 placeholder:text-neutral-400 focus:border-farad-primary disabled:opacity-70";
      ...
      {ownsGroup ? (
        <div className="py-4 text-center">
          ...
          <button
            type="button"
            onClick={onClose}
            className="mt-6 h-12 w-full rounded-2xl bg-farad-primary text-[15px] font-bold text-white outline-none transition-colors duration-200 hover:bg-farad-forest focus-visible:ring-2 focus-visible:ring-farad-primary/40"
          >
            Mengerti
          </button>
        </div>
        ...
        <form action={action} className="flex flex-col gap-4">
            ...
            <div className="mt-1.5 grid grid-cols-4 gap-2">
              {STYLES.map((option, i) => (
                <button
                  ...
                  className={`flex flex-col items-center gap-1.5 rounded-2xl border-2 p-2.5 outline-none transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-farad-primary/40 ${
                    style === i
                      ? "border-farad-primary bg-farad-sage"
                      : "border-app-line bg-white hover:border-farad-primary/40"
                  }`}
                >
          ...
          <p className="rounded-2xl bg-farad-sage px-4 py-3 text-[13px] leading-5 text-farad-forest">
          ...
          <div className="mt-1 flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="h-12 flex-1 rounded-2xl bg-white text-[15px] font-bold text-neutral-600 ring-1 ring-app-line outline-none transition-colors duration-200 hover:bg-neutral-50 focus-visible:ring-2 focus-visible:ring-farad-primary/40"
            >
              Batal
            </button>
            <button
              type="submit"
              disabled={busy}
              className="h-12 flex-[2] rounded-2xl bg-farad-primary text-[15px] font-bold text-white outline-none transition-colors duration-200 hover:bg-farad-forest focus-visible:ring-2 focus-visible:ring-farad-primary focus-visible:ring-offset-2 disabled:opacity-60"
            >
