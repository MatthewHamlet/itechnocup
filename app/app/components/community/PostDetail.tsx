    ...
    >
      {post && (
        <div className="flex flex-col gap-5">
          ...
          {post.imageUrl && (
            <div className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl bg-app-canvas ring-1 ring-app-line">
              <Image
                src={post.imageUrl}
                alt=""
                fill
          ...
          <div>
            ...
            {!loading && comments.length === 0 && (
              <p className="mt-4 rounded-2xl bg-app-canvas/60 px-4 py-6 text-center text-[14px] leading-6 text-neutral-500">
              ...
              {comments.map((comment) => (
                <li key={comment.id} className="flex gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 whitespace-pre-line rounded-2xl rounded-tl-md bg-app-canvas/70 px-3.5 py-2.5 text-[14.5px] leading-6 text-neutral-700">
                      {comment.body}
                    </p>
                  </div>
