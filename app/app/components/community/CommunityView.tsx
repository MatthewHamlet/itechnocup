...
import CommunityToolbar, { type FeedTab } from "./CommunityToolbar";
import CommunityFeed, { tabCounts } from "./CommunityFeed";
...
import type { SortKey } from "@/lib/community/data";
...
export default function CommunityPage({ data }: { data: CommunityData }) {
  ...
  return (
    <div className="flex h-[calc(100svh-var(--farad-bottom-nav))] w-full flex-col px-4 pb-4 pt-4 sm:px-6 md:px-8 xl:px-12">
