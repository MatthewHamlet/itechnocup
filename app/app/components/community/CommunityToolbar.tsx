...
import { SORTS, type SortKey } from "@/lib/community/data";
      ...
      >
        ...
        <div className="relative min-w-0 flex-1">
          ...
          {query && (
            <button
              ...
              className="absolute right-2 top-1/2 grid h-8 w-8 -translate-y-1/2 place-items-center rounded-full text-neutral-400 outline-none transition-colors duration-200 hover:bg-app-canvas hover:text-neutral-700 focus-visible:ring-2 focus-visible:ring-farad-primary/40"
            >
        ...
        <div ref={filterRef} className="relative shrink-0">
          <button
            ...
            className={`inline-flex h-11 items-center gap-2 rounded-full bg-white px-4 text-[14px] font-semibold outline-none ring-1 transition-colors duration-200 hover:bg-white/90 focus-visible:ring-2 focus-visible:ring-white/70 ${
              sort === "relevan"
                ...
                : "text-farad-forest ring-farad-primary"
            }`}
          >
          ...
          {filterOpen && (
            <div
              ...
              className="absolute right-0 z-30 mt-2 w-60 overflow-hidden rounded-2xl bg-white p-1.5 shadow-[0_1px_2px_rgba(24,32,24,0.04),0_20px_44px_-24px_rgba(24,32,24,0.45)] ring-1 ring-app-line"
            >
              ...
              {SORTS.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-[14px] outline-none transition-colors duration-200 hover:bg-app-canvas focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-farad-primary/40 ${
                      on ? "font-semibold text-farad-forest" : "text-neutral-600"
                    }`}
                  >
        ...
        <div ref={createRef} className="relative shrink-0">
          <button
            ...
            aria-haspopup="menu"
            className="inline-flex h-11 shrink-0 items-center gap-2 rounded-full bg-white px-4 text-[14px] font-bold text-farad-forest outline-none transition-colors duration-200 hover:bg-white/90 focus-visible:ring-2 focus-visible:ring-white/70"
          >
          ...
          {createOpen && (
            <div
              ...
              className="absolute right-0 z-30 mt-2 w-56 overflow-hidden rounded-2xl bg-white p-1.5 shadow-[0_1px_2px_rgba(24,32,24,0.04),0_20px_44px_-24px_rgba(24,32,24,0.45)] ring-1 ring-app-line"
            >
              <button
                type="button"
                role="menuitem"
                ...
                className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left outline-none transition-colors duration-200 hover:bg-app-canvas focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-farad-primary/40"
              >
                <span className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-farad-sage text-farad-forest">
        ...
        {TABS.map((item) => {
          ...
          return (
            <button
              ...
              className={`inline-flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1.5 text-[13px] font-semibold outline-none ring-1 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-farad-primary/40 ${
                active
                  ? "bg-farad-primary text-white ring-farad-primary"
                  : "bg-white text-neutral-600 ring-app-line hover:bg-app-canvas"
              }`}
            >
